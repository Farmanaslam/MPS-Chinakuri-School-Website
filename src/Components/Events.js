...
export default function Events() {
  ...
  return (
    <div className="defaultContainer my-5">
      <div
        className="view-image fixed left-0 top-0 h-full w-full bg-black bg-opacity-90 z-20 opacity-0 pointer-events-none transition-opacity"
        onClick={handleViewerClick}
      ></div>

      <div className="view-buttons text-white fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[95%] z-20 flex items-center justify-between opacity-0 pointer-events-none">
        <button
      ...
      <h3 className='h3 py-2 pt-4 text-center'>Events</h3>
